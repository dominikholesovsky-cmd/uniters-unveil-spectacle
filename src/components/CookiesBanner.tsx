...
const CookiesBanner = ({ language }: CookiesBannerProps) => {
  ...
  const content = {
    cs: {
      message:
        "Používáme soubory cookies, abychom vám zajistili co nejlepší zážitek na našich webových stránkách.",
      accept: "Přijmout",
      decline: "Odmítnout",
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50 p-3 sm:p-4 bg-foreground:80 text-background shadow-2xl animate-slide-in-right">
