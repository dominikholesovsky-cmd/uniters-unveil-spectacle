...
const LocationMap = ({ language }: LocationMapProps) => {
  ...
  return (
    <section
      id="location-map"
      className="py-8 sm:py-10 md:py-12 bg-gradient-to-b from-background via-background-light to-background-light"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div
            className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-elegant animate-fade-in mx-auto"
            style={{ animationDelay: "0.2s", maxWidth: "80%" }}
          >            
