...
const RegistrationForm = ({ language }: RegistrationFormProps) => {
  ...
  useEffect(() => {
    ...
    setIsPortalUnlocked(true); // PREVIEW MODE - change back to: new Date() >= PORTAL_UNLOCK_DATE
  }, []);
  ...
  const content = {
    cs: {
      ...
      portalDescription: "Vaše účast může mít větší dopad, než si myslíte. Více se dozvíte v portálu.",
    ...
    en: {
      ...
      portalDescription: "Your attendance may have a bigger impact than you think. Find out more in the portal.",
