      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-xl sm:rounded-2xl p-8 sm:p-10 md:p-12 shadow-elegant border border-border animate-fade-in max-w-xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-muted-foreground mb-3 sm:mb-4">
              {t.title}
            </h2>
            ...
            <div className="flex flex-col gap-4 sm:gap-6 justify-center items-stretch sm:items-center"> 
              <a href="tel:+420776285777" className="flex items-center justify-center sm:justify-start gap-3 text-base sm:text-lg text-foreground hover:text-primary transition-colors group w-full" > 
                ...
                </div> <span className="font-medium break-all sm:break-normal">+420 776 285 777</span> 
            ...
            >
              ...
              <span className="font-semibold text-muted-foreground break-all sm:break-normal">
                hello@uniters.io
              </span>
            </a>
          </div>
